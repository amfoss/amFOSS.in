...
const page = () => {
  ...
  return (
    <>
      <div className="flex-col flex-center justify-center overflow-hidden items-center px-10 md:mx-[3vw] lg:mx-[9vw] xl:mx-[8vw] 2xl:mx-[9vw]">
        ...
        <div className="py-12 sm:py-48 max-w-screen-2xl">
          <motion.div
            variants={clubLife2Varients}
            transition={{ duration: 0.5, delay: 0.1 }}
            initial="initial"
        ...
        <div className="bg-[#1E1D1D] flex items-center relative block">
          <div className="py-12 bg-[#1E1D1D] sm:pt-24 max-w-screen-2xl px-6 ">
            <motion.div
              variants={clubLife2Varients}
              transition={{ duration: 0.5, delay: 0.1 }}
              initial="initial"
        ...
        <div className="mx-auto max-w-screen-2xl pt-12 sm:pt-48">
